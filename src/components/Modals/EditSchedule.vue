...
<div  class="modale card">
    ...
    <div class="container">
        ...
        <input type="hidden" v-model="schedule.id">
...
export default {
  data(){
    ...
    props:['showe','toggleModalEdit' , 'scheduletoedit'],
    methods : {
      async editSchedule(){
        console.log(this.scheduletoedit.id);
        console.log(this.scheduletoedit.date);
        console.log(this.schedule)
   var response = await fetch("http://localhost:8000/api/schedules/"+this.schedule.id+"/", {
    method: 'put',
    headers: {
