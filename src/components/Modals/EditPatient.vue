...
<div class="bloc-modale">
    <div class="overlay" v-on:click="toggleModalEditPatient"></div>
<div  class="modale card">

    <div class="container">
        <div class="text">Edit Patient form</div>
        <form @submit.prevent="editPatient">
           <div class="form-row">
              <div class="input-data">
                 <input type="text" v-model="patient.firstName" required>
                 <div class="underline"></div>
                 <label style="left:0px;">First Name</label>
              </div>
              <div class="input-data">
                 <input type="text" v-model="patient.lastName" required>
                 <div class="underline"></div>
                 <label style="left:0px;">Last Name</label>
              </div>
               <div class="input-data">
                 <input type="text" v-model="patient.cin" required>
                 <div class="underline"></div>
           ...
           <div class="form-row">
             <div class="input-data">
                 <input type="text"  v-model="patient.phone" required>
                 <div class="underline"></div>
                 <label style="left:0px;">Phone</label>
              </div>
              <div class="input-data">
                 <input type="text" v-model="patient.email" required>
                 <div class="underline"></div>
                 <label style="left:0px;">Email Address</label>
              </div>
             <div class="input-data">
                 <input type="password" v-model="patient.password" required>
                 <div class="underline"></div>
           ...
           <div class="form-row">
              <div class="input-data">
                 <input type="text"  v-model="patient.address" required>
                 <div class="underline"></div>
                 <label style="left:0px;">Adress</label>
              </div>
               <div class="input-data">
                 <input name="date" type="date" onfocus="(this.type='date')" onblur="if(!this.value)this.type='text'" v-model="patient.dateBirth">
                 <div class="underline"></div>
                 <label style="left:0px;">Birthday date</label>
              </div>
...
-->  
                    ...
                    <div class="input-data">
                       <div class="inner"></div>
                         <button type="button" class="btn btn-danger submit-btn" style="border-radius: 8px;margin-left:30%; height: 40px; width: 120px;" @click="toggleModalEditPatient">Cancel</button>
                    </div>
                 </div>
        </form>
...
export default {
 ...
 props:['showeditpatient','toggleModalEditPatient','patienttoedit'],
  methods:{
    async editPatient(){
        console.log(this.patient.firstName)
   var response = await fetch("http://localhost:8000/api/patients/"+this.patient.id+"/", {
    method: 'put',
    headers: {
