...
<div class="bloc-modale">
    <div class="overlay" v-on:click="toggleModalAddPatient"></div>
<div  class="modale card">

    <div class="container">
        <div class="text">Add Patient form</div>
...
-->  
                    ...
                    <div class="input-data">
                       <div class="inner"></div>
                         <button type="button" class="btn btn-danger submit-btn" style="border-radius: 8px;margin-left:30%; height: 40px; width: 120px;" @click="toggleModalAddPatient">Cancel</button>
                    </div>
                 </div>
        </form>
...
export default {
 ...
 props:['showaddpatient','toggleModalAddPatient'],
  methods:{
  async createPatient(){
