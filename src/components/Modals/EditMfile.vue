...
<div  class="modale card">
    ...
    <div class="container">
        <div class="text">Edit medical file</div>
        <form @submit.prevent="editMfile">
           <div class="form-row">
...
export default {
  ...
  async editMfile(){
   ...
   var response = await fetch("http://localhost:8000/api/medicalfiles/"+this.mfile.id+"/", {
    method: 'put',
    headers: {
 ...
 created(){
    ...
    props:['showeditmfile','toggleModalEdit','mfiletoedit']
